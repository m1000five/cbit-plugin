...
INSERT INTO MAPPING_CODE(ID, BANKID, IFXCODE, HOSTCODE, TRANCODE, ACCTTYPEHOSTID, ERROR, DESC_ERROR_HOM) VALUES((SELECT MAX(ID) FROM MAPPING_CODE) + 1, '00010524', '700', '3', 'C_${ServiceNameUpper}', NULL, '1', 'Error de conexion con el WSRR');
INSERT INTO MAPPING_CODE(ID, BANKID, IFXCODE, HOSTCODE, TRANCODE, ACCTTYPEHOSTID, ERROR, DESC_ERROR_HOM) VALUES((SELECT MAX(ID) FROM MAPPING_CODE) + 1, '00010524', '700', '4', 'C_${ServiceNameUpper}', NULL, '1', 'Error de conexion con el WSRR');
INSERT INTO MAPPING_CODE(ID, BANKID, IFXCODE, HOSTCODE, TRANCODE, ACCTTYPEHOSTID, ERROR, DESC_ERROR_HOM) VALUES((SELECT MAX(ID) FROM MAPPING_CODE) + 1, '00010524', '300', '2666', 'C_${ServiceNameUpper}', NULL, '1', 'Error al abrir Cola');
INSERT INTO MAPPING_CODE(ID, BANKID, IFXCODE, HOSTCODE, TRANCODE, ACCTTYPEHOSTID, ERROR, DESC_ERROR_HOM) VALUES((SELECT MAX(ID) FROM MAPPING_CODE) + 1, '0052', '300', '5', 'C_${ServiceNameUpper}', NULL, '1', 'Error de conexion con el cliente - TimeOut');
INSERT INTO MAPPING_CODE(ID, BANKID, IFXCODE, HOSTCODE, TRANCODE, ACCTTYPEHOSTID, ERROR, DESC_ERROR_HOM) VALUES((SELECT MAX(ID) FROM MAPPING_CODE) + 1, '0052', '700', '3', 'C_${ServiceNameUpper}', NULL, '1', 'Error de conexion con el WSRR');
INSERT INTO MAPPING_CODE(ID, BANKID, IFXCODE, HOSTCODE, TRANCODE, ACCTTYPEHOSTID, ERROR, DESC_ERROR_HOM) VALUES((SELECT MAX(ID) FROM MAPPING_CODE) + 1, '0052', '700', '4', 'C_${ServiceNameUpper}', NULL, '1', 'Error de conexion con el WSRR');
INSERT INTO MAPPING_CODE(ID, BANKID, IFXCODE, HOSTCODE, TRANCODE, ACCTTYPEHOSTID, ERROR, DESC_ERROR_HOM) VALUES((SELECT MAX(ID) FROM MAPPING_CODE) + 1, '0052', '300', '2666', 'C_${ServiceNameUpper}', NULL, '1', 'Error al abrir Cola');
