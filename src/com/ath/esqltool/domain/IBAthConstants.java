...
public interface IBAthConstants {

	public String PREFIX_MQ = "Colas_MigracionBUS_";
	public String PREFIX_MQ_REVERSE = "Reverso_Colas_MigracionBUS_";
	public String SUFFIX_MQ = ".mq";
	public String SUFFIX_MQ_REQ = "_Reqxxxx.mq";
	...
	public String CONSTANTS = "CTRL_ConstantFile.esql";
	public String FMG_CONSTANTS = "FMG_ConstantFile.esql";
	...
	public String SUFFIX_START_FLOW = "_START.msgflow";
	public String SUFFIX_START_PR = "_START_PrepareMsgFMG.esql";

	
	public String SUFFIX_STEP_WITHOUT_EXT = "_STEP";
		
	public String PREFIX_FMG = "FMG_";
	public String PREFIX_ADP = "ADP_";
